...
$('.contact-form').submit(function() {
	...
	var sum =  a.find('[name = sum]').val();
	var term =  a.find('[name = term]').val();
	var landing_number =  a.find('[name = landing_number]').val();
		...
		$.ajax({
			...
			success: function(json) {
				if(json['success']) {
					...
					a.find('[type=text],[type=email],[type=number]').val('');
					/*
					setTimeout(function() {
